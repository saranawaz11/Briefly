    ...
    return (
        <section className='relative overflow-hidden bg-gray-100'>
            <div className='py-12 lg:py-24 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 lg:pt-12'>
                ...
                <div className='grid gird-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto relative'>
                    {steps.map((step, idx) => (
    ...
    return(
        <div className='relative p-6 rounded-2xl bg-white/5 backdrop-blur-xs border border-white/10 hover:border-rose-500/20 transition-colors group w-full'>
            <div className='flex flex-col gap-4 h-full'>
                <div className='flex items-center justify-center h-24 w-24 bg-gray-300 mx-auto rounded-2xl bg-linear-to-br from-rose-500/10 to-transparent group-hover:from-rose-500/20 transition-colors'>
